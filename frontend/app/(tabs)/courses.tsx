    ...
    <View className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 px-4 pt-4" showsVerticalScrollIndicator={false}>
        <View className="mb-6 bg-[#6A1B9A] p-6 rounded-[30px] shadow-lg shadow-purple-200">
          <Text className="text-white text-xl font-bold mb-2">Genel İlerleme</Text>
          <View className="flex-row justify-between items-center mb-2">
            <Text className="text-white/80 font-medium">Tamamlanan Dersler</Text>
            <Text className="text-white font-bold">{Math.round(state.progress)}%</Text>
          </View>
